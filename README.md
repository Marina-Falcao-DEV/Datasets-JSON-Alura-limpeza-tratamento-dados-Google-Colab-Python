# Datasets-JSON-Alura-limpeza-tratamento-dados-Google-Colab-Python
Desafios de preparos de datasets para análises através das etapas de limpeza e e tratamento de dados (Linguagem: Python/ Ferramenta: Google Colab) 


**_Desafio 1: Churn de uma empresa de telecomunicações_** 📶🛜🌐 
